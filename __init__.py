...
Version: 2019.3.12.1
License: Apache 2.0
Description: This script is used to download the day's image from bing.com and set it as the dekstop wallpaper on Windows.
"""
...
if __name__ == "__main__":
    ...
    with urllib.request.urlopen(base_url + json_url) as url:
        ...
        img_url = data["images"][0]["url"]  # Get today's image url postfix. This should be something like /th?id=OHR.GrapeHarvest_EN-US9833740254_1920x1080.jpg&rf=NorthMale_1920x1080.jpg&pid=hp
    ...
    urllib.request.urlretrieve(base_url + img_url, join(save_loc, img_name))  # Download img from Bing and save in save location.
    
    print("Setting image as background...")
    ctypes.windll.user32.SystemParametersInfoW(20, 0, join(save_loc, img_name), 0)  # Set the downloaded image as the wallpaper.
